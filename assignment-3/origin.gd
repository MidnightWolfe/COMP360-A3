...
@onready var arm1 = $arm1 #To get the properties of arm1
@onready var arm2 = $arm2 #To get the properties of arm2
...
func _physics_process(delta: float) -> void:
	...
	arm1.apply_torque(Vector3(10,10,0)) #Applying torque to keep the first arm rotating
